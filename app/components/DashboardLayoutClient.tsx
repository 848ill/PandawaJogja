  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 flex flex-col">
        {/* Header/topbar */}
        <header className="flex items-center h-14 px-2 sm:px-4 border-b bg-white shadow-sm relative">
          {!isSidebarOpen && (
            <button
              className="p-2 rounded hover:bg-gray-100 absolute left-2 top-1/2 -translate-y-1/2"
